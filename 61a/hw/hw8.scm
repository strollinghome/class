...
(define (derive-product exp var)
  (make-sum (make-product (addend exp) (derive (augend exp) var)) (make-product (derive (addend exp) var) (augend exp))))
...
(define (base exponentiation)
  (make-exponentiation (cadr exponentiation) 1))
...
(define (derive-exponentiation exp var)
  (make-product (exponent exp) (make-exponentiation var (- (exponent exp) 1))))
