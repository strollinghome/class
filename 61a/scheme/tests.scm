...
(begin (define y '(1 2 3)) (define x 5))
; expect x
...
(define (pow base exponent)
    (cond
         ((= exponent 1) base)
            ((even? exponent) (pow (square base) (/ exponent 2)))
               (else (* base (pow base (- exponent 1))))))
; expect pow

(pow 5 20)
; expect 95367431640625

(cond 
  ((= 21 12) 'wrong)
  ((= (let ((x -1) (y 1)) (+ x y))  0) 'right))
; expect right
...
(define z (mu (a b) (* a (* b c))))
; expect z

(define y (lambda (a b c) (z a b)))
; expect y
