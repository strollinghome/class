...
public class GraphTest {
    ...
    public void testRemoveUndirected() {
        ...
        G.remove(4);
        assertEquals("Wrong number of edges", 2, G.edgeSize());
        ...
        G1.add(4, 3);
        G1.add(4, 1);
        assertEquals("Wrong number of edges", 6, G1.edgeSize());
        G1.remove(1);
        assertEquals("Wrong number of edges", 2, G1.edgeSize());
    }
    ...
    public void testEdgeId() {
        ...
        G.remove(4, 1);
        G.add(4, 1);
        assertEquals("Wrong edgeId", 3, G.edgeId(4, 1));
    }
    ...
    public void testEdgeIdUndirected() {
        ...
        G.add(1, 2);
        G.add(1, 3);
        assertEquals("Wrong edgeId", 1, G.edgeId(3, 4));
        assertEquals("Wrong edgeId", 1, G.edgeId(4, 3));
        assertEquals("Wrong edgeId", 2, G.edgeId(5, 4));
        assertEquals("Wrong edgeId", 3, G.edgeId(4, 2));
        assertEquals("Wrong edgeId", 4, G.edgeId(2, 1));
        assertEquals("Wrong edgeId", 5, G.edgeId(3, 1));
        G.remove(3, 4);
        G.add(4, 3);
        assertEquals("Wrong edgeId", 6, G.edgeId(3, 4));
    }
    ...
    public void testSuccessors() {
        ...
        List<Integer> expected = Arrays.<Integer>asList(4, 2, 3, 1);
        List<Integer> actual = new ArrayList<Integer>();
        for (Integer i : successors) {
            actual.add(i);
        }
        assertEquals("Wrong order", expected, actual);
    }
